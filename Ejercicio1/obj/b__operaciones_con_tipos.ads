...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_operaciones_con_tipos" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2c666263#;
   pragma Export (C, u00001, "operaciones_con_tiposB");
