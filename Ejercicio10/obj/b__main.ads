...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#fd246d0e#;
   pragma Export (C, u00001, "mainB");
   u00002 : constant Version_32 := 16#2e11c0b1#;
   pragma Export (C, u00002, "system__standard_libraryB");
   u00003 : constant Version_32 := 16#664ecad3#;
   pragma Export (C, u00003, "system__standard_libraryS");
   u00004 : constant Version_32 := 16#5e358802#;
   pragma Export (C, u00004, "putterserverB");
   u00005 : constant Version_32 := 16#e4416008#;
   pragma Export (C, u00005, "putterserverS");
   u00006 : constant Version_32 := 16#ffaa9e94#;
   pragma Export (C, u00006, "ada__calendar__delaysB");
   u00007 : constant Version_32 := 16#d86d2f1d#;
   pragma Export (C, u00007, "ada__calendar__delaysS");
   u00008 : constant Version_32 := 16#48583e4e#;
   pragma Export (C, u00008, "ada__calendarB");
   u00009 : constant Version_32 := 16#31350a81#;
   ...
   u00104 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00104, "system__concat_4B");
   u00105 : constant Version_32 := 16#519e7a34#;
   pragma Export (C, u00105, "system__concat_4S");
   u00106 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00106, "system__concat_3B");
   u00107 : constant Version_32 := 16#248a0db1#;
   pragma Export (C, u00107, "system__concat_3S");
   u00108 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00108, "system__concat_2B");
   u00109 : constant Version_32 := 16#2d5a86c4#;
   pragma Export (C, u00109, "system__concat_2S");
   u00110 : constant Version_32 := 16#96c62183#;
   pragma Export (C, u00110, "system__taskingB");
   u00111 : constant Version_32 := 16#256a579d#;
   pragma Export (C, u00111, "system__taskingS");
   u00112 : constant Version_32 := 16#0c334715#;
   pragma Export (C, u00112, "system__task_primitivesS");
   u00113 : constant Version_32 := 16#4e3ebb7e#;
   pragma Export (C, u00113, "system__os_interfaceS");
   u00114 : constant Version_32 := 16#0039537b#;
   pragma Export (C, u00114, "interfaces__c__stringsB");
   u00115 : constant Version_32 := 16#eda3d306#;
   pragma Export (C, u00115, "interfaces__c__stringsS");
   u00116 : constant Version_32 := 16#cc709166#;
   pragma Export (C, u00116, "system__task_primitives__operationsB");
   u00117 : constant Version_32 := 16#9723968e#;
   ...
   u00119 : constant Version_32 := 16#cf061228#;
   ...
   u00121 : constant Version_32 := 16#26aedc33#;
   pragma Export (C, u00121, "system__interrupt_managementS");
   u00122 : constant Version_32 := 16#7bca5a8d#;
   pragma Export (C, u00122, "system__multiprocessorsB");
   u00123 : constant Version_32 := 16#1756ce67#;
   pragma Export (C, u00123, "system__multiprocessorsS");
   u00124 : constant Version_32 := 16#ce7dfb56#;
   pragma Export (C, u00124, "system__task_infoB");
   u00125 : constant Version_32 := 16#5a49699d#;
   pragma Export (C, u00125, "system__task_infoS");
   u00126 : constant Version_32 := 16#4ddebf0b#;
   pragma Export (C, u00126, "system__tasking__debugB");
   u00127 : constant Version_32 := 16#d3b35c55#;
   pragma Export (C, u00127, "system__tasking__debugS");
   ...
   u00130 : constant Version_32 := 16#ac06ab59#;
   pragma Export (C, u00130, "system__tasking__protected_objectsB");
   u00131 : constant Version_32 := 16#242da0e0#;
   pragma Export (C, u00131, "system__tasking__protected_objectsS");
   u00132 : constant Version_32 := 16#2e7731ce#;
   pragma Export (C, u00132, "system__soft_links__taskingB");
   u00133 : constant Version_32 := 16#e939497e#;
   pragma Export (C, u00133, "system__soft_links__taskingS");
   u00134 : constant Version_32 := 16#3880736e#;
   pragma Export (C, u00134, "ada__exceptions__is_null_occurrenceB");
   u00135 : constant Version_32 := 16#5ca174ae#;
   pragma Export (C, u00135, "ada__exceptions__is_null_occurrenceS");
   u00136 : constant Version_32 := 16#d5216b8e#;
   ...
   u00147 : constant Version_32 := 16#8c178268#;
   pragma Export (C, u00147, "ada__strings__text_buffersB");
   u00148 : constant Version_32 := 16#0800bb5e#;
   pragma Export (C, u00148, "ada__strings__text_buffersS");
   u00149 : constant Version_32 := 16#cd3494c7#;
   pragma Export (C, u00149, "ada__strings__utf_encodingB");
   u00150 : constant Version_32 := 16#37e3917d#;
   pragma Export (C, u00150, "ada__strings__utf_encodingS");
   u00151 : constant Version_32 := 16#d1d1ed0b#;
   pragma Export (C, u00151, "ada__strings__utf_encoding__wide_stringsB");
   u00152 : constant Version_32 := 16#103ad78c#;
   pragma Export (C, u00152, "ada__strings__utf_encoding__wide_stringsS");
   u00153 : constant Version_32 := 16#c2b98963#;
   pragma Export (C, u00153, "ada__strings__utf_encoding__wide_wide_stringsB");
   u00154 : constant Version_32 := 16#91eda35b#;
   pragma Export (C, u00154, "ada__strings__utf_encoding__wide_wide_stringsS");
   u00155 : constant Version_32 := 16#b3f0dfa6#;
   pragma Export (C, u00155, "ada__tagsB");
   u00156 : constant Version_32 := 16#cb8ac80c#;
   pragma Export (C, u00156, "ada__tagsS");
   u00157 : constant Version_32 := 16#5534feb6#;
   pragma Export (C, u00157, "system__htableB");
   u00158 : constant Version_32 := 16#ab38e2fe#;
   pragma Export (C, u00158, "system__htableS");
   u00159 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00159, "system__string_hashB");
   u00160 : constant Version_32 := 16#09668980#;
   pragma Export (C, u00160, "system__string_hashS");
   u00161 : constant Version_32 := 16#5fc04ee2#;
   pragma Export (C, u00161, "system__put_imagesB");
   u00162 : constant Version_32 := 16#52d4e162#;
   pragma Export (C, u00162, "system__put_imagesS");
   u00163 : constant Version_32 := 16#e264263f#;
   pragma Export (C, u00163, "ada__strings__text_buffers__utilsB");
   u00164 : constant Version_32 := 16#608bd105#;
   pragma Export (C, u00164, "ada__strings__text_buffers__utilsS");
   u00165 : constant Version_32 := 16#95817ed8#;
   pragma Export (C, u00165, "system__finalization_rootB");
   u00166 : constant Version_32 := 16#60082284#;
   pragma Export (C, u00166, "system__finalization_rootS");
   u00167 : constant Version_32 := 16#ef7f0714#;
   pragma Export (C, u00167, "system__tasking__protected_objects__operationsB");
   u00168 : constant Version_32 := 16#07408f44#;
   pragma Export (C, u00168, "system__tasking__protected_objects__operationsS");
   u00169 : constant Version_32 := 16#886988be#;
   pragma Export (C, u00169, "system__tasking__entry_callsB");
   u00170 : constant Version_32 := 16#526fb901#;
   pragma Export (C, u00170, "system__tasking__entry_callsS");
   u00171 : constant Version_32 := 16#1f882186#;
   ...
   u00173 : constant Version_32 := 16#acbd1abf#;
   pragma Export (C, u00173, "system__tasking__utilitiesB");
   u00174 : constant Version_32 := 16#6b757be7#;
   pragma Export (C, u00174, "system__tasking__utilitiesS");
   u00175 : constant Version_32 := 16#2ebb1120#;
   pragma Export (C, u00175, "system__tasking__rendezvousB");
   u00176 : constant Version_32 := 16#da433d5e#;
   pragma Export (C, u00176, "system__tasking__rendezvousS");
   u00177 : constant Version_32 := 16#ead5bc8c#;
   pragma Export (C, u00177, "system__tasking__stagesB");
   u00178 : constant Version_32 := 16#6153a6f3#;
   pragma Export (C, u00178, "system__tasking__stagesS");
   u00179 : constant Version_32 := 16#91809229#;
   pragma Export (C, u00179, "ada__real_timeB");
   u00180 : constant Version_32 := 16#1ad7dfc0#;
   pragma Export (C, u00180, "ada__real_timeS");
   u00181 : constant Version_32 := 16#9fda8cbc#;
   pragma Export (C, u00181, "putterB");
   u00182 : constant Version_32 := 16#b7806a67#;
   pragma Export (C, u00182, "putterS");
   u00183 : constant Version_32 := 16#d8bb58e0#;
   pragma Export (C, u00183, "ada__text_ioB");
   u00184 : constant Version_32 := 16#1eb2ee39#;
   pragma Export (C, u00184, "ada__text_ioS");
   u00185 : constant Version_32 := 16#73d2d764#;
   pragma Export (C, u00185, "interfaces__c_streamsB");
   u00186 : constant Version_32 := 16#066a78a0#;
   pragma Export (C, u00186, "interfaces__c_streamsS");
   u00187 : constant Version_32 := 16#30f1a29e#;
   pragma Export (C, u00187, "system__file_ioB");
   u00188 : constant Version_32 := 16#888bb071#;
   pragma Export (C, u00188, "system__file_ioS");
   u00189 : constant Version_32 := 16#d265cbbc#;
   pragma Export (C, u00189, "system__file_control_blockS");
   u00190 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00190, "system__memoryB");
   u00191 : constant Version_32 := 16#76873720#;
