...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_tareas_dinamicas" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#35d5d010#;
   pragma Export (C, u00001, "tareas_dinamicasB");
   ...
   u00005 : constant Version_32 := 16#91809229#;
   pragma Export (C, u00005, "ada__real_timeB");
   u00006 : constant Version_32 := 16#1ad7dfc0#;
   ...
   u00093 : constant Version_32 := 16#96c62183#;
   pragma Export (C, u00093, "system__taskingB");
   u00094 : constant Version_32 := 16#256a579d#;
   pragma Export (C, u00094, "system__taskingS");
   u00095 : constant Version_32 := 16#0c334715#;
   pragma Export (C, u00095, "system__task_primitivesS");
   u00096 : constant Version_32 := 16#4e3ebb7e#;
   pragma Export (C, u00096, "system__os_interfaceS");
   u00097 : constant Version_32 := 16#0039537b#;
   pragma Export (C, u00097, "interfaces__c__stringsB");
   u00098 : constant Version_32 := 16#eda3d306#;
   pragma Export (C, u00098, "interfaces__c__stringsS");
   u00099 : constant Version_32 := 16#cc709166#;
   pragma Export (C, u00099, "system__task_primitives__operationsB");
   u00100 : constant Version_32 := 16#9723968e#;
   pragma Export (C, u00100, "system__task_primitives__operationsS");
   u00101 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00101, "system__float_controlB");
   u00102 : constant Version_32 := 16#cf061228#;
   pragma Export (C, u00102, "system__float_controlS");
   u00103 : constant Version_32 := 16#6387a759#;
   pragma Export (C, u00103, "system__interrupt_managementB");
   u00104 : constant Version_32 := 16#26aedc33#;
   pragma Export (C, u00104, "system__interrupt_managementS");
   u00105 : constant Version_32 := 16#7bca5a8d#;
   pragma Export (C, u00105, "system__multiprocessorsB");
   u00106 : constant Version_32 := 16#1756ce67#;
   pragma Export (C, u00106, "system__multiprocessorsS");
   u00107 : constant Version_32 := 16#24ec69e6#;
   pragma Export (C, u00107, "system__os_primitivesB");
   u00108 : constant Version_32 := 16#280734e2#;
   pragma Export (C, u00108, "system__os_primitivesS");
   u00109 : constant Version_32 := 16#2f9cb76c#;
   pragma Export (C, u00109, "system__arith_64B");
   u00110 : constant Version_32 := 16#9d9eabfb#;
   pragma Export (C, u00110, "system__arith_64S");
   u00111 : constant Version_32 := 16#05c60a38#;
   pragma Export (C, u00111, "system__task_lockB");
   u00112 : constant Version_32 := 16#4e70667a#;
   pragma Export (C, u00112, "system__task_lockS");
   u00113 : constant Version_32 := 16#b8c476a4#;
   pragma Export (C, u00113, "system__win32__extS");
   u00114 : constant Version_32 := 16#ce7dfb56#;
   pragma Export (C, u00114, "system__task_infoB");
   u00115 : constant Version_32 := 16#5a49699d#;
   pragma Export (C, u00115, "system__task_infoS");
   u00116 : constant Version_32 := 16#4ddebf0b#;
   pragma Export (C, u00116, "system__tasking__debugB");
   u00117 : constant Version_32 := 16#d3b35c55#;
   pragma Export (C, u00117, "system__tasking__debugS");
   u00118 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00118, "system__concat_2B");
   u00119 : constant Version_32 := 16#2d5a86c4#;
   pragma Export (C, u00119, "system__concat_2S");
   u00120 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00120, "system__concat_3B");
   u00121 : constant Version_32 := 16#248a0db1#;
   pragma Export (C, u00121, "system__concat_3S");
   u00122 : constant Version_32 := 16#617d5887#;
   pragma Export (C, u00122, "system__stack_usageB");
   u00123 : constant Version_32 := 16#8d63b971#;
   pragma Export (C, u00123, "system__stack_usageS");
   u00124 : constant Version_32 := 16#8c178268#;
   pragma Export (C, u00124, "ada__strings__text_buffersB");
   u00125 : constant Version_32 := 16#0800bb5e#;
   pragma Export (C, u00125, "ada__strings__text_buffersS");
   u00126 : constant Version_32 := 16#cd3494c7#;
   pragma Export (C, u00126, "ada__strings__utf_encodingB");
   u00127 : constant Version_32 := 16#37e3917d#;
   ...
   u00129 : constant Version_32 := 16#103ad78c#;
   ...
   u00131 : constant Version_32 := 16#91eda35b#;
   pragma Export (C, u00131, "ada__strings__utf_encoding__wide_wide_stringsS");
   u00132 : constant Version_32 := 16#b3f0dfa6#;
   pragma Export (C, u00132, "ada__tagsB");
   u00133 : constant Version_32 := 16#cb8ac80c#;
   pragma Export (C, u00133, "ada__tagsS");
   u00134 : constant Version_32 := 16#5534feb6#;
   pragma Export (C, u00134, "system__htableB");
   u00135 : constant Version_32 := 16#ab38e2fe#;
   pragma Export (C, u00135, "system__htableS");
   u00136 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00136, "system__string_hashB");
   u00137 : constant Version_32 := 16#09668980#;
   pragma Export (C, u00137, "system__string_hashS");
   u00138 : constant Version_32 := 16#d8bb58e0#;
   pragma Export (C, u00138, "ada__text_ioB");
   u00139 : constant Version_32 := 16#1eb2ee39#;
   ...
   u00142 : constant Version_32 := 16#5fc04ee2#;
   pragma Export (C, u00142, "system__put_imagesB");
   u00143 : constant Version_32 := 16#52d4e162#;
   pragma Export (C, u00143, "system__put_imagesS");
   u00144 : constant Version_32 := 16#e264263f#;
   pragma Export (C, u00144, "ada__strings__text_buffers__utilsB");
   u00145 : constant Version_32 := 16#608bd105#;
   ...
   u00147 : constant Version_32 := 16#066a78a0#;
   pragma Export (C, u00147, "interfaces__c_streamsS");
   u00148 : constant Version_32 := 16#30f1a29e#;
   pragma Export (C, u00148, "system__file_ioB");
   u00149 : constant Version_32 := 16#888bb071#;
   ...
   u00152 : constant Version_32 := 16#60082284#;
   pragma Export (C, u00152, "system__finalization_rootS");
   u00153 : constant Version_32 := 16#d265cbbc#;
   ...
   u00155 : constant Version_32 := 16#519e7a34#;
   pragma Export (C, u00155, "system__concat_4S");
   u00156 : constant Version_32 := 16#2ebb1120#;
   pragma Export (C, u00156, "system__tasking__rendezvousB");
   u00157 : constant Version_32 := 16#da433d5e#;
   ...
   u00159 : constant Version_32 := 16#45aa48e1#;
   pragma Export (C, u00159, "system__restrictionsS");
   u00160 : constant Version_32 := 16#886988be#;
   pragma Export (C, u00160, "system__tasking__entry_callsB");
   u00161 : constant Version_32 := 16#526fb901#;
   pragma Export (C, u00161, "system__tasking__entry_callsS");
   u00162 : constant Version_32 := 16#d499f4ac#;
   pragma Export (C, u00162, "system__tasking__initializationB");
   u00163 : constant Version_32 := 16#cd0eb8a9#;
   pragma Export (C, u00163, "system__tasking__initializationS");
   u00164 : constant Version_32 := 16#2e7731ce#;
   pragma Export (C, u00164, "system__soft_links__taskingB");
   u00165 : constant Version_32 := 16#e939497e#;
   pragma Export (C, u00165, "system__soft_links__taskingS");
   u00166 : constant Version_32 := 16#3880736e#;
   pragma Export (C, u00166, "ada__exceptions__is_null_occurrenceB");
   u00167 : constant Version_32 := 16#5ca174ae#;
   pragma Export (C, u00167, "ada__exceptions__is_null_occurrenceS");
   u00168 : constant Version_32 := 16#132211d8#;
