...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#826f5258#;
   ...
   u00102 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00102, "ada__float_text_ioB");
   u00103 : constant Version_32 := 16#39060f6c#;
   pragma Export (C, u00103, "ada__float_text_ioS");
   u00104 : constant Version_32 := 16#d8bb58e0#;
   pragma Export (C, u00104, "ada__text_ioB");
   u00105 : constant Version_32 := 16#1eb2ee39#;
   ...
   u00108 : constant Version_32 := 16#8c178268#;
   pragma Export (C, u00108, "ada__strings__text_buffersB");
   u00109 : constant Version_32 := 16#0800bb5e#;
   pragma Export (C, u00109, "ada__strings__text_buffersS");
   u00110 : constant Version_32 := 16#cd3494c7#;
   pragma Export (C, u00110, "ada__strings__utf_encodingB");
   u00111 : constant Version_32 := 16#37e3917d#;
   ...
   u00113 : constant Version_32 := 16#103ad78c#;
   ...
   u00115 : constant Version_32 := 16#91eda35b#;
   pragma Export (C, u00115, "ada__strings__utf_encoding__wide_wide_stringsS");
   u00116 : constant Version_32 := 16#b3f0dfa6#;
   pragma Export (C, u00116, "ada__tagsB");
   u00117 : constant Version_32 := 16#cb8ac80c#;
   pragma Export (C, u00117, "ada__tagsS");
   u00118 : constant Version_32 := 16#5534feb6#;
   pragma Export (C, u00118, "system__htableB");
   u00119 : constant Version_32 := 16#ab38e2fe#;
   pragma Export (C, u00119, "system__htableS");
   u00120 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00120, "system__string_hashB");
   u00121 : constant Version_32 := 16#09668980#;
   ...
   u00123 : constant Version_32 := 16#52d4e162#;
   ...
   u00129 : constant Version_32 := 16#888bb071#;
   ...
   u00132 : constant Version_32 := 16#60082284#;
   pragma Export (C, u00132, "system__finalization_rootS");
   u00133 : constant Version_32 := 16#d265cbbc#;
   ...
   u00136 : constant Version_32 := 16#ecc88e78#;
   pragma Export (C, u00136, "system__fat_fltS");
   u00137 : constant Version_32 := 16#6424aad3#;
   ...
   u00139 : constant Version_32 := 16#cf061228#;
   ...
   u00141 : constant Version_32 := 16#44802e3b#;
   pragma Export (C, u00141, "system__img_utilS");
   u00142 : constant Version_32 := 16#690df0ad#;
   pragma Export (C, u00142, "system__powten_fltS");
   u00143 : constant Version_32 := 16#c90890af#;
   pragma Export (C, u00143, "system__img_lfltS");
   u00144 : constant Version_32 := 16#cafa8775#;
   pragma Export (C, u00144, "system__fat_lfltS");
   u00145 : constant Version_32 := 16#b684afd1#;
   pragma Export (C, u00145, "system__img_lluS");
   u00146 : constant Version_32 := 16#0be1c959#;
   pragma Export (C, u00146, "system__powten_lfltS");
   u00147 : constant Version_32 := 16#1422974c#;
   pragma Export (C, u00147, "system__img_llfS");
   u00148 : constant Version_32 := 16#b02a299f#;
   pragma Export (C, u00148, "system__fat_llfS");
   u00149 : constant Version_32 := 16#b6fa998a#;
   pragma Export (C, u00149, "system__powten_llfS");
   u00150 : constant Version_32 := 16#18ee5867#;
   pragma Export (C, u00150, "system__val_fltS");
   u00151 : constant Version_32 := 16#8aea7eed#;
   pragma Export (C, u00151, "system__exn_fltS");
   u00152 : constant Version_32 := 16#0414e57b#;
   pragma Export (C, u00152, "system__val_lfltS");
   u00153 : constant Version_32 := 16#34ab9f34#;
   pragma Export (C, u00153, "system__exn_lfltS");
   u00154 : constant Version_32 := 16#de111da4#;
   pragma Export (C, u00154, "system__val_llfS");
   u00155 : constant Version_32 := 16#19055f44#;
   pragma Export (C, u00155, "system__exn_llfS");
   u00156 : constant Version_32 := 16#91809229#;
   pragma Export (C, u00156, "ada__real_timeB");
   u00157 : constant Version_32 := 16#1ad7dfc0#;
   pragma Export (C, u00157, "ada__real_timeS");
   u00158 : constant Version_32 := 16#96c62183#;
   pragma Export (C, u00158, "system__taskingB");
   u00159 : constant Version_32 := 16#256a579d#;
   pragma Export (C, u00159, "system__taskingS");
   u00160 : constant Version_32 := 16#0c334715#;
   pragma Export (C, u00160, "system__task_primitivesS");
   u00161 : constant Version_32 := 16#4e3ebb7e#;
   pragma Export (C, u00161, "system__os_interfaceS");
   u00162 : constant Version_32 := 16#0039537b#;
   pragma Export (C, u00162, "interfaces__c__stringsB");
   u00163 : constant Version_32 := 16#eda3d306#;
   pragma Export (C, u00163, "interfaces__c__stringsS");
   u00164 : constant Version_32 := 16#cc709166#;
   pragma Export (C, u00164, "system__task_primitives__operationsB");
   u00165 : constant Version_32 := 16#9723968e#;
   pragma Export (C, u00165, "system__task_primitives__operationsS");
   u00166 : constant Version_32 := 16#6387a759#;
   pragma Export (C, u00166, "system__interrupt_managementB");
   u00167 : constant Version_32 := 16#26aedc33#;
   pragma Export (C, u00167, "system__interrupt_managementS");
   u00168 : constant Version_32 := 16#7bca5a8d#;
   pragma Export (C, u00168, "system__multiprocessorsB");
   u00169 : constant Version_32 := 16#1756ce67#;
   pragma Export (C, u00169, "system__multiprocessorsS");
   u00170 : constant Version_32 := 16#ce7dfb56#;
   pragma Export (C, u00170, "system__task_infoB");
   u00171 : constant Version_32 := 16#5a49699d#;
   pragma Export (C, u00171, "system__task_infoS");
   u00172 : constant Version_32 := 16#4ddebf0b#;
   pragma Export (C, u00172, "system__tasking__debugB");
   u00173 : constant Version_32 := 16#d3b35c55#;
   ...
   u00175 : constant Version_32 := 16#2d5a86c4#;
   ...
   u00178 : constant Version_32 := 16#617d5887#;
   pragma Export (C, u00178, "system__stack_usageB");
   u00179 : constant Version_32 := 16#8d63b971#;
   pragma Export (C, u00179, "system__stack_usageS");
   u00180 : constant Version_32 := 16#95658ed1#;
   pragma Export (C, u00180, "controladorB");
   u00181 : constant Version_32 := 16#68b25189#;
   pragma Export (C, u00181, "controladorS");
   u00182 : constant Version_32 := 16#6c56296f#;
   pragma Export (C, u00182, "data_typeS");
   u00183 : constant Version_32 := 16#547023e2#;
   pragma Export (C, u00183, "guardarB");
   u00184 : constant Version_32 := 16#6b391b83#;
   pragma Export (C, u00184, "guardarS");
   u00185 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00185, "system__concat_4B");
   u00186 : constant Version_32 := 16#519e7a34#;
   pragma Export (C, u00186, "system__concat_4S");
   u00187 : constant Version_32 := 16#377a4b2b#;
   pragma Export (C, u00187, "leerB");
   u00188 : constant Version_32 := 16#4f9fea54#;
   pragma Export (C, u00188, "leerS");
   u00189 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00189, "ada__integer_text_ioB");
   u00190 : constant Version_32 := 16#2ec7c168#;
   pragma Export (C, u00190, "ada__integer_text_ioS");
   u00191 : constant Version_32 := 16#3720d920#;
   pragma Export (C, u00191, "system__img_biuS");
   u00192 : constant Version_32 := 16#7a7e1efe#;
   pragma Export (C, u00192, "system__img_llbS");
   u00193 : constant Version_32 := 16#15e60e4c#;
   pragma Export (C, u00193, "system__img_lliS");
   u00194 : constant Version_32 := 16#0d8feb8c#;
   pragma Export (C, u00194, "system__img_lllbS");
   u00195 : constant Version_32 := 16#7e360bb4#;
   pragma Export (C, u00195, "system__img_llliS");
   u00196 : constant Version_32 := 16#07fbf280#;
   pragma Export (C, u00196, "system__img_lllwS");
   u00197 : constant Version_32 := 16#264c6bf5#;
   pragma Export (C, u00197, "system__img_llwS");
   u00198 : constant Version_32 := 16#08fa6212#;
   pragma Export (C, u00198, "system__img_wiuS");
   u00199 : constant Version_32 := 16#ae4beccb#;
   pragma Export (C, u00199, "system__val_intS");
   u00200 : constant Version_32 := 16#a5b55d2f#;
   pragma Export (C, u00200, "system__val_unsS");
   u00201 : constant Version_32 := 16#e37e7d10#;
   pragma Export (C, u00201, "system__val_llliS");
   u00202 : constant Version_32 := 16#f82486d6#;
   pragma Export (C, u00202, "system__val_llluS");
   u00203 : constant Version_32 := 16#0de7ae30#;
   pragma Export (C, u00203, "ada__strings__fixedB");
   u00204 : constant Version_32 := 16#64881af1#;
   pragma Export (C, u00204, "ada__strings__fixedS");
   u00205 : constant Version_32 := 16#bb264ce2#;
   pragma Export (C, u00205, "ada__strings__searchB");
   u00206 : constant Version_32 := 16#73987e07#;
   pragma Export (C, u00206, "ada__strings__searchS");
   u00207 : constant Version_32 := 16#12af50fd#;
   pragma Export (C, u00207, "mostrarB");
   u00208 : constant Version_32 := 16#0e847325#;
   pragma Export (C, u00208, "mostrarS");
   u00209 : constant Version_32 := 16#57dc4eb4#;
   pragma Export (C, u00209, "seguridadB");
   u00210 : constant Version_32 := 16#6bb651ab#;
   pragma Export (C, u00210, "seguridadS");
   u00211 : constant Version_32 := 16#9b2ec661#;
   pragma Export (C, u00211, "simulacionB");
   u00212 : constant Version_32 := 16#710bc610#;
   pragma Export (C, u00212, "simulacionS");
   u00213 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00213, "system__memoryB");
   u00214 : constant Version_32 := 16#76873720#;
