...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#72049050#;
   pragma Export (C, u00001, "mainB");
   u00002 : constant Version_32 := 16#2e11c0b1#;
   pragma Export (C, u00002, "system__standard_libraryB");
   u00003 : constant Version_32 := 16#664ecad3#;
   pragma Export (C, u00003, "system__standard_libraryS");
   u00004 : constant Version_32 := 16#bbf6f5e1#;
   pragma Export (C, u00004, "ad_cardB");
   u00005 : constant Version_32 := 16#2ec0c599#;
   ...
   u00008 : constant Version_32 := 16#39060f6c#;
   ...
   u00095 : constant Version_32 := 16#d8bb58e0#;
   pragma Export (C, u00095, "ada__text_ioB");
   u00096 : constant Version_32 := 16#1eb2ee39#;
   ...
   u00099 : constant Version_32 := 16#8c178268#;
   pragma Export (C, u00099, "ada__strings__text_buffersB");
   u00100 : constant Version_32 := 16#0800bb5e#;
   pragma Export (C, u00100, "ada__strings__text_buffersS");
   u00101 : constant Version_32 := 16#cd3494c7#;
   pragma Export (C, u00101, "ada__strings__utf_encodingB");
   u00102 : constant Version_32 := 16#37e3917d#;
   pragma Export (C, u00102, "ada__strings__utf_encodingS");
   u00103 : constant Version_32 := 16#d1d1ed0b#;
   pragma Export (C, u00103, "ada__strings__utf_encoding__wide_stringsB");
   u00104 : constant Version_32 := 16#103ad78c#;
   pragma Export (C, u00104, "ada__strings__utf_encoding__wide_stringsS");
   u00105 : constant Version_32 := 16#c2b98963#;
   pragma Export (C, u00105, "ada__strings__utf_encoding__wide_wide_stringsB");
   u00106 : constant Version_32 := 16#91eda35b#;
   pragma Export (C, u00106, "ada__strings__utf_encoding__wide_wide_stringsS");
   u00107 : constant Version_32 := 16#b3f0dfa6#;
   pragma Export (C, u00107, "ada__tagsB");
   u00108 : constant Version_32 := 16#cb8ac80c#;
   pragma Export (C, u00108, "ada__tagsS");
   u00109 : constant Version_32 := 16#5534feb6#;
   pragma Export (C, u00109, "system__htableB");
   u00110 : constant Version_32 := 16#ab38e2fe#;
   pragma Export (C, u00110, "system__htableS");
   u00111 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00111, "system__string_hashB");
   u00112 : constant Version_32 := 16#09668980#;
   ...
   u00147 : constant Version_32 := 16#547023e2#;
   pragma Export (C, u00147, "guardarB");
   u00148 : constant Version_32 := 16#6b391b83#;
   pragma Export (C, u00148, "guardarS");
   ...
   u00152 : constant Version_32 := 16#248a0db1#;
   pragma Export (C, u00152, "system__concat_3S");
   u00153 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00153, "system__concat_2B");
   u00154 : constant Version_32 := 16#2d5a86c4#;
   pragma Export (C, u00154, "system__concat_2S");
   u00155 : constant Version_32 := 16#6c56296f#;
   pragma Export (C, u00155, "data_typeS");
   u00156 : constant Version_32 := 16#377a4b2b#;
   pragma Export (C, u00156, "leerB");
   u00157 : constant Version_32 := 16#4f9fea54#;
   pragma Export (C, u00157, "leerS");
   u00158 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00158, "ada__integer_text_ioB");
   u00159 : constant Version_32 := 16#2ec7c168#;
   pragma Export (C, u00159, "ada__integer_text_ioS");
   u00160 : constant Version_32 := 16#3720d920#;
   pragma Export (C, u00160, "system__img_biuS");
   u00161 : constant Version_32 := 16#7a7e1efe#;
   pragma Export (C, u00161, "system__img_llbS");
   u00162 : constant Version_32 := 16#15e60e4c#;
   pragma Export (C, u00162, "system__img_lliS");
   u00163 : constant Version_32 := 16#0d8feb8c#;
   pragma Export (C, u00163, "system__img_lllbS");
   u00164 : constant Version_32 := 16#7e360bb4#;
   pragma Export (C, u00164, "system__img_llliS");
   u00165 : constant Version_32 := 16#07fbf280#;
   pragma Export (C, u00165, "system__img_lllwS");
   u00166 : constant Version_32 := 16#264c6bf5#;
   pragma Export (C, u00166, "system__img_llwS");
   u00167 : constant Version_32 := 16#08fa6212#;
   pragma Export (C, u00167, "system__img_wiuS");
   u00168 : constant Version_32 := 16#ae4beccb#;
   pragma Export (C, u00168, "system__val_intS");
   u00169 : constant Version_32 := 16#a5b55d2f#;
   pragma Export (C, u00169, "system__val_unsS");
   u00170 : constant Version_32 := 16#e37e7d10#;
   pragma Export (C, u00170, "system__val_llliS");
   u00171 : constant Version_32 := 16#f82486d6#;
   pragma Export (C, u00171, "system__val_llluS");
   u00172 : constant Version_32 := 16#0de7ae30#;
   pragma Export (C, u00172, "ada__strings__fixedB");
   u00173 : constant Version_32 := 16#64881af1#;
   pragma Export (C, u00173, "ada__strings__fixedS");
   u00174 : constant Version_32 := 16#bb264ce2#;
   ...
   u00193 : constant Version_32 := 16#280734e2#;
   pragma Export (C, u00193, "system__os_primitivesS");
   u00194 : constant Version_32 := 16#2f9cb76c#;
   pragma Export (C, u00194, "system__arith_64B");
   u00195 : constant Version_32 := 16#9d9eabfb#;
   pragma Export (C, u00195, "system__arith_64S");
   u00196 : constant Version_32 := 16#05c60a38#;
   pragma Export (C, u00196, "system__task_lockB");
   u00197 : constant Version_32 := 16#4e70667a#;
   pragma Export (C, u00197, "system__task_lockS");
   u00198 : constant Version_32 := 16#b8c476a4#;
   pragma Export (C, u00198, "system__win32__extS");
   u00199 : constant Version_32 := 16#ce7dfb56#;
   pragma Export (C, u00199, "system__task_infoB");
   u00200 : constant Version_32 := 16#5a49699d#;
   pragma Export (C, u00200, "system__task_infoS");
   u00201 : constant Version_32 := 16#96c62183#;
   pragma Export (C, u00201, "system__taskingB");
   u00202 : constant Version_32 := 16#256a579d#;
   pragma Export (C, u00202, "system__taskingS");
   u00203 : constant Version_32 := 16#617d5887#;
   pragma Export (C, u00203, "system__stack_usageB");
   u00204 : constant Version_32 := 16#8d63b971#;
   pragma Export (C, u00204, "system__stack_usageS");
   u00205 : constant Version_32 := 16#4ddebf0b#;
   pragma Export (C, u00205, "system__tasking__debugB");
   u00206 : constant Version_32 := 16#d3b35c55#;
   pragma Export (C, u00206, "system__tasking__debugS");
   u00207 : constant Version_32 := 16#d5216b8e#;
   ...
   u00209 : constant Version_32 := 16#100eaf58#;
   pragma Export (C, u00209, "system__restrictionsB");
   u00210 : constant Version_32 := 16#45aa48e1#;
   pragma Export (C, u00210, "system__restrictionsS");
   u00211 : constant Version_32 := 16#d499f4ac#;
   pragma Export (C, u00211, "system__tasking__initializationB");
   u00212 : constant Version_32 := 16#cd0eb8a9#;
   pragma Export (C, u00212, "system__tasking__initializationS");
   u00213 : constant Version_32 := 16#132211d8#;
   pragma Export (C, u00213, "system__tasking__task_attributesB");
   u00214 : constant Version_32 := 16#7dbadc03#;
   pragma Export (C, u00214, "system__tasking__task_attributesS");
   u00215 : constant Version_32 := 16#ef7f0714#;
   pragma Export (C, u00215, "system__tasking__protected_objects__operationsB");
   u00216 : constant Version_32 := 16#07408f44#;
   pragma Export (C, u00216, "system__tasking__protected_objects__operationsS");
   u00217 : constant Version_32 := 16#886988be#;
   ...
   u00219 : constant Version_32 := 16#1f882186#;
   pragma Export (C, u00219, "system__tasking__queuingB");
   u00220 : constant Version_32 := 16#73e13001#;
   pragma Export (C, u00220, "system__tasking__queuingS");
   u00221 : constant Version_32 := 16#acbd1abf#;
   pragma Export (C, u00221, "system__tasking__utilitiesB");
   u00222 : constant Version_32 := 16#6b757be7#;
   pragma Export (C, u00222, "system__tasking__utilitiesS");
   u00223 : constant Version_32 := 16#2ebb1120#;
   pragma Export (C, u00223, "system__tasking__rendezvousB");
   u00224 : constant Version_32 := 16#da433d5e#;
   pragma Export (C, u00224, "system__tasking__rendezvousS");
   u00225 : constant Version_32 := 16#ffaa9e94#;
   pragma Export (C, u00225, "ada__calendar__delaysB");
   u00226 : constant Version_32 := 16#d86d2f1d#;
   pragma Export (C, u00226, "ada__calendar__delaysS");
   u00227 : constant Version_32 := 16#48583e4e#;
   pragma Export (C, u00227, "ada__calendarB");
   u00228 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00228, "ada__calendarS");
   u00229 : constant Version_32 := 16#91809229#;
   pragma Export (C, u00229, "ada__real_timeB");
   u00230 : constant Version_32 := 16#1ad7dfc0#;
   pragma Export (C, u00230, "ada__real_timeS");
   u00231 : constant Version_32 := 16#97d7e40a#;
   pragma Export (C, u00231, "ada__real_time__delaysB");
   u00232 : constant Version_32 := 16#0a5c26d7#;
   pragma Export (C, u00232, "ada__real_time__delaysS");
   u00233 : constant Version_32 := 16#95658ed1#;
   pragma Export (C, u00233, "controladorB");
   u00234 : constant Version_32 := 16#68b25189#;
   pragma Export (C, u00234, "controladorS");
   u00235 : constant Version_32 := 16#12af50fd#;
   pragma Export (C, u00235, "mostrarB");
   u00236 : constant Version_32 := 16#0e847325#;
   pragma Export (C, u00236, "mostrarS");
   u00237 : constant Version_32 := 16#034b8550#;
   pragma Export (C, u00237, "seguridadB");
   u00238 : constant Version_32 := 16#6bb651ab#;
   pragma Export (C, u00238, "seguridadS");
   u00239 : constant Version_32 := 16#9b2ec661#;
   pragma Export (C, u00239, "simulacionB");
   u00240 : constant Version_32 := 16#710bc610#;
   pragma Export (C, u00240, "simulacionS");
   u00241 : constant Version_32 := 16#ead5bc8c#;
   pragma Export (C, u00241, "system__tasking__stagesB");
   u00242 : constant Version_32 := 16#6153a6f3#;
   pragma Export (C, u00242, "system__tasking__stagesS");
   u00243 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00243, "system__memoryB");
   u00244 : constant Version_32 := 16#76873720#;
